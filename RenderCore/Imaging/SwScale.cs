...
namespace RenderCore.Imaging
{
    ...
    {
        private const string libraryName = "swscale-2.dll";
        ...
        {
            private SwsVector lumH;
            private SwsVector lumV;
            private SwsVector chrH;
            private SwsVector chrV;
        }

        [StructLayout(LayoutKind.Sequential)]
        public struct SwsVector
        {
            private IntPtr coeff;              ///< pointer to the list of coefficients
            private int length;                 ///< number of coefficients in the vector
        }
    }
}