...
namespace RenderCore.Imaging
{
    internal unsafe sealed class ConverterResizer : IDisposable
    {
        private static Dictionary<PixelAlignmentType, SwScale.SwsPixelFormat> m_pixelTypeMapper = new Dictionary<PixelAlignmentType, SwScale.SwsPixelFormat>();
        private static Dictionary<PixelFormat, SwScale.SwsPixelFormat> m_rgbMapper = new Dictionary<PixelFormat, SwScale.SwsPixelFormat>();
        private static byte** pInput;
        private IntPtr m_context = IntPtr.Zero;
        private Size m_sourceSize, m_targetSize;
        private PixelAlignmentType m_sourceType, m_targetType;
